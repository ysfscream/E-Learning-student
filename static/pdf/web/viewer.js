      ...
      if (evt.state) {
        ...
        if (self.uid === 0) {
          var previousParams = (self.previousHash && self.currentBookmark &&
            self.previousHash !== self.currentBookmark) ? { hash: self.currentBookmark, page: self.currentPage } : { page: 1 };
...
var PDFDocumentProperties = (function PDFDocumentPropertiesClosure() {
  ...
  PDFDocumentProperties.prototype = {
    ...
    _parseDate: function PDFDocumentProperties_parseDate(inputDate) {
      ...
      return mozL10n.get('document_properties_date_string', { date: dateString, time: timeString },
        '{{date}}, {{time}}');
    }
  };
...
var PDFThumbnailView = (function PDFThumbnailViewClosure() {
  ...
  PDFThumbnailView.prototype = {
    ...
    _getPageDrawContext: function PDFThumbnailView_getPageDrawContext(noCtxScale) {
      ...
      canvas.setAttribute('aria-label', mozL10n.get('thumb_page_canvas', { page: this.id }, 'Thumbnail of Page {{page}}'));
